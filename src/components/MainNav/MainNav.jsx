...
import {Container, Nav, Navbar, Row, Col, Button, Dropdown} from 'react-bootstrap';
...
const MainNav = () => {
  return (
    <Navbar fixed="top" expand="lg" >
        <Container className={''}>
            <Row className={'w-100 mx-auto mx-0'}>
                <Col md={7} xs={12} className={'d-flex justify-content-between justify-content-md-start align-items-center position-relative pb-2'}>
                        <a href="./" className={'d-inline-block me-4'}>
                        <img
                            src={ smallLogo }
                            width="90"
                            height="90"
                ...
                <Col md={5} xs={12} className={'d-flex align-items-center justify-content-center'}>
                    <Nav className={''}>
